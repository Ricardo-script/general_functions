...
const handleTelefoneChange = (event: React.ChangeEvent<HTMLInputElement>) => {
	const maskedTelefone = phoneMask(event.target.value);
	if (form.current !== null) {
		form.current.contato.value = maskedTelefone; // Atualiza o valor no elemento diretamente
	}
};


<Input label='Telephone' name='contato' placeholder='(11) 90000-0000' onChange={handleTelefoneChange} />

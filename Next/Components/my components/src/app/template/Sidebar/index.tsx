...
import { Logo, More } from "@/app/assets/icons";
import {
    Container,
    Menu,
    HeaderAside,
        ...
        <Container>
            <Menu $toggle={toggleMenu}>
                <HeaderAside>
                    ...
                    <AreaIcon onClick={() => setToggleMenu(prev => !prev)} $toggle={toggleMenu}>
                ...
                <AreaMenu>
                    ...
                    {menu.map((items, index) => (
                        <MenuItem key={index} icon={items.icon} title={items.name} navigate={items.navigate} toggleMenu={toggleMenu} />
                    ))}
                </AreaMenu>
                <MenuFooter>
                    <Divider />
